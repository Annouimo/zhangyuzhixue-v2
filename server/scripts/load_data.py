...
FILE_TABLE_MAP = [
    ...
    ('accounts_teachers',             'accounts_teacher'),
    ...
    ('courses_class_groups',          'courses_classgroup'),
    ('courses_class_courses',         'courses_classcourse'),
    ('courses_class_course_assignments', 'courses_classcourseassignment'),
    ('courses_assignments',           'courses_assignment'),
    ('courses_assignment_questions',  'courses_assignmentquestion'),
