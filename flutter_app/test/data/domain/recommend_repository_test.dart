...
void main() {
  ...
  group('RecommendRepository', () {
    ...
    test('getSmartList cold start recommends an unseen question', () async {
      await aDb
      ...
      expect(list.single.recommendReason, isNotEmpty);
    });

    test(
      'getSmartList with >5 attempted questions returns suggestions',
      () async {
        await aDb
            .into(aDb.conceptTags)
            .insert(
