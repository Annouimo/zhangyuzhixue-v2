      ...
      return Container(
        ...
        child: Row(
          children: [
            ...
            SizedBox(width: 48, child: Text('${isPositive ? '+' : ''}${(r.change / 10).toStringAsFixed(1)}',
              style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600,
                color: isPositive ? AppColors.success : AppColors.error))),
            SizedBox(width: 48, child: Text((r.earned / 10).toStringAsFixed(1),
              style: const TextStyle(fontSize: 12, color: AppColors.textSecondary))),
            SizedBox(width: 48, child: Text((r.bonus / 10).toStringAsFixed(1),
              style: const TextStyle(fontSize: 12, color: AppColors.textSecondary))),
            SizedBox(width: 48, child: Text((r.spent / 10).toStringAsFixed(1),
              style: const TextStyle(fontSize: 12, color: AppColors.textSecondary))),
            SizedBox(width: 48, child: Text((r.available / 10).toStringAsFixed(1),
