...
class $$AssignmentsTableFilterComposer
    extends Composer<_$CoursesDatabase, $AssignmentsTable> {
...
class $$AssignmentsTableTableManager
    extends
        RootTableManager<
          ...
          (
            AssignmentRow,
            BaseReferences<_$CoursesDatabase, $AssignmentsTable, AssignmentRow>,
          ),
          AssignmentRow,
          PrefetchHooks Function()
        > {
  $$AssignmentsTableTableManager(_$CoursesDatabase db, $AssignmentsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
class $$AssignmentQuestionsTableFilterComposer
    extends Composer<_$CoursesDatabase, $AssignmentQuestionsTable> {
