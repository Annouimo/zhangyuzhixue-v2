...
OutputBaseFilename=章鱼智学-1.1.0-beta.3-windows
...
[Files]
Source: "D:\Hermes\zhangyuzhixue_app_v2\flutter_app\build\windows\x64\runner\Release\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\Hermes\zhangyuzhixue_app_v2\flutter_app\build\windows\x64\runner\Release\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
